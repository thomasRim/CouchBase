...
struct Options {
    BOOL shouldPinchScale = NO;
    
    // (X is left-right, Y is up-down, Z is forward-back)
    GLKVector3 initialVolumeSizeInMeters;
    // ScannerModeFoot: GLKVector3Make(0.2f, 0.4f, 0.1f)
    // ScannerModeWeightBearing: GLKVector3Make(0.5f, 0.5f, 0.5f)
...
#include "ScanViewControllerDelegate.h"

@interface ScanViewController : UIViewController <STBackgroundTaskDelegate, MeshViewDelegate, UIPopoverControllerDelegate, UIGestureRecognizerDelegate, UIAlertViewDelegate>
{
    BOOL firstFrame;
...
@property (nonatomic, assign) BOOL forceColorScan;
@property (nonatomic, assign) ScanFootSubtypes optionOfLeftRightFoot;
@property (nonatomic, assign) ScannerMode scannerMode;
...
@property (weak, nonatomic) IBOutlet InsetLabel *trackingLostLabel;

@property (weak, nonatomic) IBOutlet UISwitch *enable5secTimerSwitch;
@property (weak, nonatomic) IBOutlet UILabel *enable5secTimerOffLabel;
@property (weak, nonatomic) IBOutlet UILabel *enable5secTimerOnLabel;

@property (weak, nonatomic) IBOutlet UISwitch *enableNewTrackerSwitch;

@property (weak, nonatomic) IBOutlet UISwitch *enableColorSwitch;
@property (weak, nonatomic) IBOutlet UILabel *enableColorOffLabel;
@property (weak, nonatomic) IBOutlet UILabel *enableColorOnLabel;
...
@property (nonatomic) BOOL didResetDistance;
